                            ...
                            <tbody>
                            	...
                            	?>
                                    <tr>
                                        ...
                                        <td class="center"><?php print $value->price;?></td>
                                        <td class="center">
                                       ...
                                       <!--  <td class="center"><a href="<?php //print base_url('edit_category'.'/'.$value->id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></td> -->

                                        <td class="center"><a href="<?php print base_url('delete_product'.'/'.$value->id);?>"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a>
                                        </td>
                                    </tr>
                                <?php }?>
                            </tbody>
