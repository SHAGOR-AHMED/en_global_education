	...
	<div class="container-fluid">
		<div class="about-top">
			<div class="text-center">
				...
				<h5>Book Your Free Consultation and one of our specialist university adviser will get back to you shortly.</h5>
			</div>
			<br>
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-5" style="border-right:1px solid #086BAD;">
				...
				<div class="col-md-5">
					<div class="details-img">
						<img class="img-responsive" src="<?= base_url('');?>assets/img/apply_online2.jpg" alt="Apply Now">
					</div>
					<br>
					<div class="details-img">
						<img class="img-responsive" src="<?= base_url('');?>assets/img/apply2.png" alt="Apply Now">
					</div>
				</div>
				<div class="col-md-1"></div>
			</div>
